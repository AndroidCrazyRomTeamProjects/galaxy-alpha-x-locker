...
public class KeyguardEffectViewNone extends FrameLayout implements KeyguardEffectViewBase {
    ...
    private SViewCoverNewUnlockArea mSViewCoverNewUnlockArea;
    ...
    public KeyguardEffectViewNone(Context context, GalaxyLockscreen aVar) {
        ...
        this.mSViewCoverNewUnlockArea = new SViewCoverNewUnlockArea(this.mContext, ((int) this.mContext.getResources().getDimension(R.dimen.keyguard_lockscreen_camera_shortcut_circle_max_radius)) * 2, (int) (4.0f * f), (int) (6.0f * f), new int[] {
        ...
        this.mSViewCoverNewUnlockArea.setLockscreen(aVar);
        addView(this.mSViewCoverNewUnlockArea);
    }
    ...
    public void reset() {
        ...
        if (this.mSViewCoverNewUnlockArea != null) {
            this.mSViewCoverNewUnlockArea.m175b();
        }
    }
    ...
    public void showUnlockAffordance(long j, Rect rect) {
        ...
        if (this.mSViewCoverNewUnlockArea != null) {
            this.mSViewCoverNewUnlockArea.m184a(j, rect);
        }
    }
    ...
    public boolean handleTouchEvent(View view, MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() == 0) {
            if (!(view instanceof KeyguardEffectViewBase)) {
                this.mSViewCoverNewUnlockArea.m187a(view.getWidth());
            } else {
                this.mSViewCoverNewUnlockArea.m189a();
            }
        }
        this.mSViewCoverNewUnlockArea.m180a(view, motionEvent);
        return true;
    }
    ...
    public void handleUnlock(View view, MotionEvent motionEvent) {
        ...
        if (this.mSViewCoverNewUnlockArea != null) {
            this.mSViewCoverNewUnlockArea.m172c();
        }
        m158e();
    }
